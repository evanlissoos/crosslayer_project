...
void clamp_float(unsigned long ptr, unsigned n, unsigned s_bits, unsigned e_bits, unsigned m_bits) {
...
ffi.cdef("""void clamp_float(unsigned long, unsigned, unsigned, unsigned, unsigned);""")
ffi.compile()
